...
To use Nexus, you'll need to first invite the Nexus to your server. You can do so by clicking `here <https://discord.com/oauth2/authorize?client_id=761036478783422484&permissions=2013785169&scope=bot%20applications.commands>`.
...
If you don't see this message or can't find it, you can always run the `!quickstart` command to create this raid channel automatically.
